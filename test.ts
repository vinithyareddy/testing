...
export class SsByLocationComponent implements AfterViewInit {
  ...
  private globeGroup!: THREE.Group;   // 👈 added as class property
  ...
  private addCountryLabels() {
    ...
    this.globeGroup.add(this.labelGroup); // 👈 labels are inside globeGroup now
  ...
  ngAfterViewInit() {
    ...
    // init label group inside globeGroup
    this.labelGroup = new THREE.Group();
    ...
    const animate = () => {
      ...
      this.globeGroup.rotation.y += ROTATION_SPEED; // 👈 rotate group
