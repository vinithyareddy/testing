...
export class SwfpByManagerFlagGradeComponent implements OnInit, AfterViewInit, OnDestroy {
 ...
 service: shared for all column charts :
        ...
        ChartValues.push({
            ...
            chartOptions: {
                ...
                chart: {
                    ...
                    backgroundColor: '#ffffff',       // opaque chart background

                    plotBackgroundColor: '#ffffff',   // opaque plot background

                    plotBorderWidth: 1,               // optional: define edges

                    // scrollablePlotArea: {

                    //     minWidth: 900,        // make this big enough for all categories
                    ...
                    //         // Sum visible series by category index

                    //         const sums: any = [];

                    //         chart.series.filter(s => s.visible).forEach(s => {

                    //             s.data.forEach((p, i) => {

                    //                 sums[i] = (sums[i] || 0) + (p.y || 0);
                    ...
                    //         const niceMax = Math.ceil(maxSum / 10) * 10; // round up to nearest 10

                    //         chart.yAxis[0].setExtremes(0, niceMax, true, false);
                ...
                xAxis: {
                  ...
                  //  scrollbar: { enabled: true, barBackgroundColor: '#c1c7d0', trackBackgroundColor: '#fff' }
                ...
                yAxis: [{
                    ...
                    title: {
                        ...
                        text: ChartOptions.yAxisTitle ? ChartOptions.yAxisTitle : 'Percentage' //ChartOptions.yAxisTitle
                    ...
                    //   maxPadding: (ChartOptions.chartTitle === 'Short Term Finance Commitments' || ChartOptions.chartTitle === 'Debt & Equity Investment Outstanding' || ChartOptions.chartTitle === 'Net Oustanding Exposure' || ChartOptions.chartTitle === 'Admin Spend' ||

                    //     ChartOptions.chartTitle === 'Net Flows' || ChartOptions.chartTitle === 'Commitments' || ChartOptions.chartTitle === 'Gross Disbursements' || ChartOptions.chartTitle === 'Loans-outstanding' ||

                    //     ChartOptions.chartTitle === 'Long Term Finance Commitments') ? 0.25 : 0,
...
now tell me what to do in this code for this widget