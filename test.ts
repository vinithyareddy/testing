...
export class SwfpByManagerFlagGradeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  navigateLeft() {
    ...
    console.log('Navigate left clicked for', this.widgetType);

    // Example: You can implement logic to navigate between different data sets

    // or time periods, or any other navigation functionality you need
  ...
  navigateRight() {
    ...
    console.log('Navigate right clicked for', this.widgetType);
